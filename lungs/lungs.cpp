...
static const Col3 LC[6]={
    {0.82f,0.18f,0.20f},{0.72f,0.17f,0.18f},{0.52f,0.20f,0.12f}, // lung fill color(main body)
    {0.36f,0.15f,0.09f},{0.20f,0.09f,0.06f},{0.08f,0.04f,0.03f}};
static const Col3 LH[6]={
    {0.98f,0.55f,0.55f},{0.88f,0.42f,0.38f},{0.65f,0.30f,0.20f}, // lung high colors(highlight)
    {0.40f,0.16f,0.11f},{0.22f,0.10f,0.07f},{0.10f,0.05f,0.04f}};
static const Col3 LS[6]={
    {0.52f,0.08f,0.09f},{0.44f,0.07f,0.07f},{0.30f,0.08f,0.05f}, //lung shadow colors(dark outline)
    {0.18f,0.05f,0.04f},{0.10f,0.03f,0.02f},{0.04f,0.02f,0.01f}};
static const Col3 BC[6]={
    {0.92f,0.90f,0.87f},{0.80f,0.77f,0.73f},{0.60f,0.56f,0.50f}, //bronchi airways color
    {0.40f,0.34f,0.26f},{0.24f,0.18f,0.13f},{0.14f,0.10f,0.07f}};
static const Col3 SC[6]={
    {0.15f,0.65f,0.22f},{0.75f,0.65f,0.05f},{0.82f,0.45f,0.05f}, //stage indicator colors (green->yellow->orange->red)
